/*Write a class(name it as Person in your program) with an instance variable, age, and a constructor that takes an integer, initialAge, as a parameter
...
package Coding;//i have initialize ,this you can skip 
import java.io.*;
import java.util.*;

public class June13Day4 {
    private int age;	
  
	public June13Day4(int initialAge) {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < T; i++) {
			int age = sc.nextInt();
			June13Day4 p = new June13Day4(age);
			p.amIOld();
			for (int j = 0; j < 3; j++) {
				p.yearPasses();
			}
